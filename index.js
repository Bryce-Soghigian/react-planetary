...
exports.Saturn = exports.default = Saturn;
...
var createEarth = function createEarth(camera, options) {
  ...
  var atmosphereGeometry = planetProto.sphere(
  ...
  var atmosphereMaterialOptions = Object.assign(
...
function Earth(props) {
  (0, _react.useEffect)(
    function() {
      ...
      galaxy_function(textureLoader, scene); // Scene, Camera, Renderer Configuration
...
function Saturn() {
  (0, _react.useEffect)(function() {
    ...
    var ring_geometry = new THREE.TorusGeometry(0.7, 0.06, 10, 100);
...
function Uranus() {
  (0, _react.useEffect)(function() {
    ...
    var ring_geometry = new THREE.RingGeometry(0.5, 0.75, 32);
